...
>
> This document has been **superseded by [GAME-DESIGN.md](../../design/GAME-DESIGN.md)** as of January 2026.
>
> The best narrative content from this document has been incorporated into GAME-DESIGN.md as quote boxes. This file is preserved for historical reference only.

**Version**: 2.0
**Date**: 2025-12-30
**Status**: ~~Active~~ **ARCHIVED** - Superseded by GAME-DESIGN.md (January 2026)
...
**Nexus Dominion** is a **single-player space empire strategy game** that features **100 AI bot opponents** with distinct personalities, **sector-based strategic geography**, and a **Star Trek LCARS-inspired interface** designed to be accessible to new players while offering depth for veterans.
